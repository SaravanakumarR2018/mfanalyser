...
| Daily history orchestration | Direct browser requests to the mfapi.in mirror, both supported payload shapes, invested-period and on-demand full-scheme requests, scheme-identity validation, concurrency progress, shared-scheme deduplication, Retry-After, missing scheme codes, endpoint reconciliation, cancellation, completed rerun no-op |
