...
320, 390, 768, and 1440 px. The entire fund list expands in the page with no
vertical height cap or internal vertical scrollbar. Column headings follow page
scrolling below the dashboard header; fund names stay pinned during horizontal
scrolling. Tests check that all rows occupy the full table height and the final
fund is reachable through page scrolling. Column navigation, sorting, filtering, folio
